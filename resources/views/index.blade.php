...
@section('main')
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <p>Friends of Pong is a demonstration of my full stack capabilities. This site was stood up using Heroku (AWS), Laravel PHP Framework, MySQL, jQuery, and Bootstrap.</p>
